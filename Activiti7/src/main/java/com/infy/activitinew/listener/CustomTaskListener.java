package com.infy.activitinew.listener;
...
@Service
public class CustomTaskListener implements TaskRuntimeEventListener {
    private Logger logger = LoggerFactory.getLogger(CustomTaskListener.class);
